...
if (isNumeric(int1) && isNumeric(int2)) console.log(min(int1, int2));
else console.log("We checked, one of the numbers you entered wasn't a number")

function min(int1, int2) {return int1 >= int2 ? int1 : int2;}
